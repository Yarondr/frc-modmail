...
class General(commands.Cog):
    ...
    async def help(self, ctx, *, command: str = None):
        ...
        page = discord.Embed(
            ...
            description="Thank you for using ModMail! Please direct message me if you wish to contact staff.",
            colour=self.bot.primary_colour,
        )
        ...
        page.add_field(
            ...
            value="Follow these steps to get the bot all ready to serve your server!\n1. Run `{ctx.prefix}setup`, there will be an interactive guide."
            f"\n2. All done! For a full list of commands, see `{ctx.prefix}help`.",
            inline=False,
        )
        all_pages.append(page)
